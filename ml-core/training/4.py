...
DATA_DIR = f"/kaggle/input/datasets/{KAGGLE_NICKNAME}/games_4"
MODELS_DIR = "/kaggle/working"

INPUT_FILE_PATH = f"{DATA_DIR}/games_2026-03-14T21-36-45-156Z.json"
OUTPUT_FILE_PATH = f"{MODELS_DIR}/engine_4.onnx"
...
def train():
    ...
    for epoch in range(MAX_EPOCHS):
        ...
        for batch_x, batch_eval, batch_result in train_loader:
            ...
            batch_y = EVAL_WEIGHT * batch_eval + RESULT_WEIGHT * batch_result
        ...
        with torch.no_grad():
            for v_x, v_eval, v_result in val_loader:
                ...
                v_y = EVAL_WEIGHT * v_eval + RESULT_WEIGHT * v_result
